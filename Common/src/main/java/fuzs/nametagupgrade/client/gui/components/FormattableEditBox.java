package fuzs.nametagupgrade.client.gui.components;

import com.mojang.blaze3d.platform.cursor.CursorTypes;
import fuzs.nametagupgrade.client.util.FormattedStringSplitter;
import fuzs.nametagupgrade.client.util.LengthLimitedCharSink;
import fuzs.nametagupgrade.util.FormattedStringDecomposer;
import fuzs.nametagupgrade.util.FormattedStringUtil;
